...
* Click `Choose a file or drag it here` and select the `kitchensink.war` file, located in your /home/vagrant/eap-qc-apps/admin1 directory. Click `Next`.
+
image::new3.png[align="center"]
...
/home/vagrant/eap-qc-apps/admin1/temperature-converter.war
----
